...
public class PointVo {	
	...
	public PointVo(int point_num, String member_id, int memeber_point, Timestamp point_date, String point_receipt) {
		super();
		this.point_num = point_num;
		this.member_id = member_id;
		this.member_point = memeber_point;
	...
	public void setMemeber_point(int member_point) {
