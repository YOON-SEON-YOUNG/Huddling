...
public class MemberVo {
	...
	public MemberVo(String member_id, String member_pw, String member_name, String member_nickname, String member_email,
			String member_adress, int member_call, int member_rating, int member_point) {
		super();
	...
	public String toString() {
		return "MemberVo [member_id=" + member_id + ", member_pw=" + member_pw + ", member_name=" + member_name
				+ ", member_nickname=" + member_nickname + ", member_email=" + member_email + ", member_adress="
				+ member_adress + ", member_call=" + member_call + ", member_rating=" + member_rating
