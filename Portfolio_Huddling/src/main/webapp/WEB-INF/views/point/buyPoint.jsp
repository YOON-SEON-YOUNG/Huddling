	...
	<div class="row">
		<div class="col-md-3">
			<table class="table" style="padding: 50px">
				...
				<tbody>
					<tr>
						<th scope="row" style="width: 120px" id="chargeRead">현재포인트<span>금액</span>
							<span style="font-size: 30px">원</span>&nbsp; <!-- Button trigger modal -->
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<label>충전아이디</label> <input type="text" class="form-control"
													id="member_id" name="member_id"> <label>충전금액</label>
