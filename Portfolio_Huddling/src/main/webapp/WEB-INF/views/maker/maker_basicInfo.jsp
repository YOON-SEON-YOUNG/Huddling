			...
			<div class="form-group">
			    ...
			    <label class="custom-file-label" for="inputGroupFile01">이미지 파일을 선택하세요</label>
					...
					<div class="form-group">
					  ...
					  <input type="hidden" id = "introImg" value=
					  "<c:if test="${basicDto.basic_representImg eq null || basicDto.basic_representImg eq ''}">makerUpload/default.png</c:if>" name="basic_representImg"/>
					</div>
				</div>
		</div>
		<div class="card-body">
